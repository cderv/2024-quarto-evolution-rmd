...
**étends** pour les personnes qui ne connaissent pas R Markdown
...
![](images/scientific-markdown-cropped.png){.lightbox height="600px"}
...
Pour R, Quarto utilise toujours Knitr sous le capot. Par conséquent, ***la grande majorité des fichiers Rmd existants*** peuvent être rendus sans modification.
...
## Unification par rapport à R Markdown {.smaller}
...
Certaines fonctionnalités nécessitent des packages R spécifiques et une syntaxe particulière. Avec Quarto, ces fonctionnalités sont intégrées dans le système de base.
...
##  {background-image="images/screenshot-page-layout.png"}
...
``` markdown
::: {.callout-note}
Notez qu'il existe cinq types utilisables : 
